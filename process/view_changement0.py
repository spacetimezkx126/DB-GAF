...
if __name__ == '__main__':
    exp_name = "db_contrast_graph_coliee"
    ...
    for data in datas:
        ...
        if data.startswith("{("):
            ...
            if count_all%6==0 and epoch=="299":
                times+=1
        ...
        for json1 in json_all:
            ...
            for key in json1:
                ...
                for data in json1[key]:
                    # print(data[0].split("_"),len(data[0].split("_")))
                    ...
                    if len(data[0].split("_"))>=5:
                        import1 = data[0].split("_")[2]
                        attr = "_".join(data[0].split("_")[3:])
                        crime = data[0].split("_")[1]
                        if crime not in all_res:
                            all_res[crime] = {}
                            all_res[crime]["important"] = {}
                            all_res[crime]["unimportant"] = {}
